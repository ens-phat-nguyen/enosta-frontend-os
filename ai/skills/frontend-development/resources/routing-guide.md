...
const PostsList = lazy(() =>
    import('@/modules/posts/components/posts-list').then(
...
const MyPage = lazy(() =>
  import("@/modules/my-feature/components/my-page").then((module) => ({
...
import { CustomAppBar } from '@/shared/components/custom-app-bar';
